...
import edu.gcsc.vrl.ug.api.RyRinstat;
...
@ComponentInfo(name="RyR_instat", category="Neuro")
public class RyRinstat_VRL implements Serializable
{
    private static final long serialVersionUID = 1L;

    private transient I_RyRinstat ryr = null;
