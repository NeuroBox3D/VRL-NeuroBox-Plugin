...
import edu.gcsc.vrl.ug.api.I_VDCC_BG_UserData;
import edu.gcsc.vrl.ug.api.MembraneTransportFV1;
import edu.gcsc.vrl.ug.api.VDCC_BG_UserData;
...
@ComponentInfo(name="VDCC", category="Neuro")
public class VDCC_VRL implements Serializable
{
    private static final long serialVersionUID = 1L;
    
    private transient I_VDCC_BG_UserData vdcc = null;
    ...
    (
        ...
        @ParamInfo(name="", style="default", options="ugx_globalTag=\"gridFile\"; fct_tag=\"fctDef\"; type=\"S2|nn:cytosolic calcium, extracellular calcium, density, potential\"")
    ...
    )
    {
        ...
        if (vdccSelFcts.length != 2) throw new RuntimeException("VDCC mechanism needs exactly two functions, but has "+vdccSelFcts.length+".");
        ...
        I_CplUserNumber vdccVoltageFct = (I_CplUserNumber) vdccData.getNumberData(2);
        
        // construct VDCC object
        vdcc = new VDCC_BG_UserData(vdccSelFcts, vdccSelSs, approxSpace);
        ...
        vdcc.set_potential_function(vdccVoltageFct);
        vdcc.init(0.0D);
    }
