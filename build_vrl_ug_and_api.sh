...
mkdir -p ${COMMON_PART_NATIVES}osx/x86
mkdir -p ${COMMON_PART_NATIVES}osx/x64
...
cp $ZIP_FILE_FOLDER/$ZIP_NAME ${COMMON_PART_NATIVES}osx/x86/${ZIP_NAME}
cp $ZIP_FILE_FOLDER/$ZIP_NAME ${COMMON_PART_NATIVES}osx/x64/${ZIP_NAME}
